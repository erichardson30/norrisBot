...
JarvisBot.prototype._replyWithDirectMessage = function (message) {
    ...
    if (message.text.indexOf('expecting') == 5 && message.text.indexOf('at') > -1) {
        ...
        // cardinal slack url
        // var url = 'https://slack.com/api/users.info?token=xoxp-2173024059-16740713250-38690264806-69748288cb&user='+user+'&pretty=1';
       
        // BEChat url
        var url = 'https://slack.com/api/users.info?token=xoxp-34772846656-34765487732-38708778018-2991cfe911&user=' + user + '&pretty=1'
